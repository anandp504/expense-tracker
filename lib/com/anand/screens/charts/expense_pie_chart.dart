        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            for(int i = 0; i < records.length; i++) {
              paymentModeSpend.add(PaymentModeSpendSlice(paymentMode: records[i].dimension,
                  amount: records[i].amount, color: charts.ColorUtil.fromDartColor(_randomColor.randomColor())));
            }
            ...
            return new charts.PieChart(
              [charts.Series<PaymentModeSpendSlice, String>(
                ...
                domainFn: (PaymentModeSpendSlice expense, _) => expense.paymentMode,
                measureFn: (PaymentModeSpendSlice expense, _) => expense.amount,
                labelAccessorFn: (PaymentModeSpendSlice expense, _) => "${expense.paymentMode}: ${expense.amount}",
